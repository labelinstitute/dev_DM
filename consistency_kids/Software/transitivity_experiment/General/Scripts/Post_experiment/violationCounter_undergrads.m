...
preProcessedFolder = '/Users/nireekodaverdian/Desktop/transitivity_experiment/preProcessed_undergrads/'; % define path of folder holding pre-processed files
...
for folder = 1:length(subjects)
    ...
    for i = 1:length(preProcessed.settings.treat1.Set)
        indx1 = preProcessed.behavioral.rank1.key(2,find(preProcessed.behavioral.rank1.key(1,:) == preProcessed.settings.treat1.Set(i,1))); % elicited rankings NOT from pictures
        ...
        % with picture data
        rankingPictureOption = (1:7); % a vector with values from 1-7. will always be in the same order for all subjects because pictureRankCoded columns correspond to the options in this same, fixed order for all subjects (i.e. first column shows elicited rank of first option)
        rankingPictureIndex = find(pictureRankCoded(:,1)==preProcessed.settings.subjID); % find the relevant rows of ranking for subject
        rankingPictureValue = rankingPictureIndex(find(pictureRankCoded(rankingPictureIndex,2)==1)); % find the row that corresponds to treatment 1 (change the number to 2 or 3 for other treatments)
    
        for i = 1:length(preProcessed.settings.treat1.Set)
            indx5 = pictureRankCoded(rankingPictureValue,find(pictureRankCoded(1,:) == preProcessed.settings.treat1.Set(i,1))); % elicited rankings from pictures
            indx6 = pictureRankCoded(rankingPictureValue,find(pictureRankCoded(1,:) == preProcessed.settings.treat1.Set(i,2)));
            indx7 = sort([indx5 indx6]); % sort them in ascending order, as this is how the first two columns of violation.heatmapMatrix are listed
            indx8 = find(violation.heatmapMatrix.treat1(:,1) == indx7(1));
            violation.heatmapMatrix.treat1(indx8((find(violation.heatmapMatrix.treat1(indx8,2) == indx7(2)))),11) = violation.heatmapMatrix.treat1(indx8((find(violation.heatmapMatrix.treat1(indx8,2) == indx7(2)))),11) + violation.treat1ICE(i); % might not make sense since ICE needs to be recomputed
            violation.heatmapMatrix.treat1(indx8((find(violation.heatmapMatrix.treat1(indx8,2) == indx7(2)))),12) = violation.heatmapMatrix.treat1(indx8((find(violation.heatmapMatrix.treat1(indx8,2) == indx7(2)))),12) + preProcessed.treat1.responseTimes(i);
            violation.heatmapMatrix.treat1(indx8((find(violation.heatmapMatrix.treat1(indx8,2) == indx7(2)))),13) = violation.heatmapMatrix.treat1(indx8((find(violation.heatmapMatrix.treat1(indx8,2) == indx7(2)))),13) + violation.treat1ICR(i);
            violation.heatmapMatrix.treat1(indx8((find(violation.heatmapMatrix.treat1(indx8,2) == indx7(2)))),14) = violation.heatmapMatrix.treat1(indx8((find(violation.heatmapMatrix.treat1(indx8,2) == indx7(2)))),14) + violation.treat1TV(i);
        end
    ...
    for i = 1:length(preProcessed.settings.treat2.Set)
        ...
        rankingPictureOption = (1:7); % a vector with values from 1-7. will always be in the same order for all subjects because pictureRankCoded columns correspond to the options in this same, fixed order for all subjects (i.e. first column shows elicited rank of first option)
        rankingPictureIndex = find(pictureRankCoded(:,1)==preProcessed.settings.subjID); % find the relevant rows of ranking for subject
        rankingPictureValue = rankingPictureIndex(find(pictureRankCoded(rankingPictureIndex,2)==2)); % find the row that corresponds to treatment 2 (change the number to 1 or 3 for other treatments)
    
        for i = 1:length(preProcessed.settings.treat2.Set)
            indx5 = pictureRankCoded(rankingPictureValue,find(pictureRankCoded(1,:) == preProcessed.settings.treat1.Set(i,1))); % elicited rankings from pictures
            indx6 = pictureRankCoded(rankingPictureValue,find(pictureRankCoded(1,:) == preProcessed.settings.treat1.Set(i,2)));
            indx7 = sort([indx5 indx6]); % sort them in ascending order, as this is how the first two columns of violation.heatmapMatrix are listed
            indx8 = find(violation.heatmapMatrix.treat2(:,1) == indx7(1));
            violation.heatmapMatrix.treat2(indx8((find(violation.heatmapMatrix.treat2(indx8,2) == indx7(2)))),11) = violation.heatmapMatrix.treat2(indx8((find(violation.heatmapMatrix.treat2(indx8,2) == indx7(2)))),11) + violation.treat2ICE(i); % might not make sense since ICE needs to be recomputed
            violation.heatmapMatrix.treat2(indx8((find(violation.heatmapMatrix.treat2(indx8,2) == indx7(2)))),12) = violation.heatmapMatrix.treat2(indx8((find(violation.heatmapMatrix.treat2(indx8,2) == indx7(2)))),12) + preProcessed.treat2.responseTimes(i);
            violation.heatmapMatrix.treat2(indx8((find(violation.heatmapMatrix.treat2(indx8,2) == indx7(2)))),13) = violation.heatmapMatrix.treat2(indx8((find(violation.heatmapMatrix.treat2(indx8,2) == indx7(2)))),13) + violation.treat2ICR(i);
            violation.heatmapMatrix.treat2(indx8((find(violation.heatmapMatrix.treat2(indx8,2) == indx7(2)))),14) = violation.heatmapMatrix.treat2(indx8((find(violation.heatmapMatrix.treat2(indx8,2) == indx7(2)))),14) + violation.treat2TV(i);
        end
    ...
    for i = 1:length(preProcessed.settings.treat3.Set)
        ...
        rankingPictureOption = (1:7); % a vector with values from 1-7. will always be in the same order for all subjects because pictureRankCoded columns correspond to the options in this same, fixed order for all subjects (i.e. first column shows elicited rank of first option)
        rankingPictureIndex = find(pictureRankCoded(:,1)==preProcessed.settings.subjID); % find the relevant rows of ranking for subject
        rankingPictureValue = rankingPictureIndex(find(pictureRankCoded(rankingPictureIndex,2)==3)); % find the row that corresponds to treatment 3 (change the number to 1 or 2 for other treatments)
    
        for i = 1:length(preProcessed.settings.treat3.Set)
            indx5 = pictureRankCoded(rankingPictureValue,find(pictureRankCoded(1,:) == preProcessed.settings.treat1.Set(i,1))); % elicited rankings from pictures
            indx6 = pictureRankCoded(rankingPictureValue,find(pictureRankCoded(1,:) == preProcessed.settings.treat1.Set(i,2)));
            indx7 = sort([indx5 indx6]); % sort them in ascending order, as this is how the first two columns of violation.heatmapMatrix are listed
            indx8 = find(violation.heatmapMatrix.treat3(:,1) == indx7(1));
            violation.heatmapMatrix.treat3(indx8((find(violation.heatmapMatrix.treat3(indx8,2) == indx7(2)))),11) = violation.heatmapMatrix.treat3(indx8((find(violation.heatmapMatrix.treat3(indx8,2) == indx7(2)))),11) + violation.treat3ICE(i); % might not make sense since ICE needs to be recomputed
            violation.heatmapMatrix.treat3(indx8((find(violation.heatmapMatrix.treat3(indx8,2) == indx7(2)))),12) = violation.heatmapMatrix.treat3(indx8((find(violation.heatmapMatrix.treat3(indx8,2) == indx7(2)))),12) + preProcessed.treat3.responseTimes(i);
            violation.heatmapMatrix.treat3(indx8((find(violation.heatmapMatrix.treat3(indx8,2) == indx7(2)))),13) = violation.heatmapMatrix.treat3(indx8((find(violation.heatmapMatrix.treat3(indx8,2) == indx7(2)))),13) + violation.treat3ICR(i);
            violation.heatmapMatrix.treat3(indx8((find(violation.heatmapMatrix.treat3(indx8,2) == indx7(2)))),14) = violation.heatmapMatrix.treat3(indx8((find(violation.heatmapMatrix.treat3(indx8,2) == indx7(2)))),14) + violation.treat3TV(i);
        end
...
% ICE from the pictures
heatmapMatrix.iceFromPic.treat1 = heatmap;
heatmapMatrix.iceAvgRxnFromPic.treat1 = heatmap;
heatmapMatrix.iceICRFromPic.treat1 = heatmap;
heatmapMatrix.iceTVFromPic.treat1 = heatmap;
heatmapMatrix.iceFromPic.treat2 = heatmap;
heatmapMatrix.iceAvgRxnFromPic.treat2 = heatmap;
heatmapMatrix.iceICRFromPic.treat2 = heatmap;
heatmapMatrix.iceTVFromPic.treat2 = heatmap;
heatmapMatrix.iceFromPic.treat3 = heatmap;
heatmapMatrix.iceAvgRxnFromPic.treat3 = heatmap;
heatmapMatrix.iceICRFromPic.treat3 = heatmap;
heatmapMatrix.iceTVFromPic.treat3 = heatmap;
...
for folder = 1:(length(subjects))
    ...
    % From the pictures
    % For treatment 1
    heatmapMatrix.iceFromPic.treat1(:,3) = heatmapMatrix.iceFromPic.treat1(:,3) + violation.heatmapMatrix.treat1(:,11); % ICE violations and ICE ranking labels of options; might not make sense since ICE needs to be re-computed
    heatmapMatrix.iceAvgRxnFromPic.treat1(:,3) = heatmapMatrix.iceAvgRxnFromPic.treat1(:,3) + violation.heatmapMatrix.treat1(:,12); % reaction times and ICE ranking labels of options
    heatmapMatrix.iceICRFromPic.treat1(:,3) = heatmapMatrix.iceICRFromPic.treat1(:,3) + violation.heatmapMatrix.treat1(:,13); % ICR violations and ICE ranking labels of options
    heatmapMatrix.iceTVFromPic.treat1(:,3) = heatmapMatrix.iceTVFromPic.treat1(:,3) + violation.heatmapMatrix.treat1(:,14); % TV violations and ICE ranking labels of options
    % For treatment 2
    heatmapMatrix.iceFromPic.treat2(:,3) = heatmapMatrix.iceFromPic.treat2(:,3) + violation.heatmapMatrix.treat2(:,11); % ICE violations and ICE ranking labels of options; might not make sense since ICE needs to be re-computed
    heatmapMatrix.iceAvgRxnFromPic.treat2(:,3) = heatmapMatrix.iceAvgRxnFromPic.treat2(:,3) + violation.heatmapMatrix.treat2(:,12); % reaction times and ICE ranking labels of options
    heatmapMatrix.iceICRFromPic.treat2(:,3) = heatmapMatrix.iceICRFromPic.treat2(:,3) + violation.heatmapMatrix.treat2(:,13); % ICR violations and ICE ranking labels of options
    heatmapMatrix.iceTVFromPic.treat2(:,3) = heatmapMatrix.iceTVFromPic.treat2(:,3) + violation.heatmapMatrix.treat2(:,14); % TV violations and ICE ranking labels of options
    % For treatment 3
    heatmapMatrix.iceFromPic.treat3(:,3) = heatmapMatrix.iceFromPic.treat3(:,3) + violation.heatmapMatrix.treat3(:,11); % ICE violations and ICE ranking labels of options; might not make sense since ICE needs to be re-computed
    heatmapMatrix.iceAvgRxnFromPic.treat3(:,3) = heatmapMatrix.iceAvgRxnFromPic.treat3(:,3) + violation.heatmapMatrix.treat3(:,12); % reaction times and ICE ranking labels of options
    heatmapMatrix.iceICRFromPic.treat3(:,3) = heatmapMatrix.iceICRFromPic.treat3(:,3) + violation.heatmapMatrix.treat3(:,13); % ICR violations and ICE ranking labels of options
    heatmapMatrix.iceTVFromPic.treat3(:,3) = heatmapMatrix.iceTVFromPic.treat3(:,3) + violation.heatmapMatrix.treat3(:,14); % TV violations and ICE ranking labels of options
...
% From pictures
heatmapMatrix.iceFromPic.treat1(:,3) = heatmapMatrix.iceFromPic.treat1(:,3)/51; % might not make sense because ICE needs to be re-computed w/ picture rankings
heatmapMatrix.iceAvgRxnFromPic.treat1(:,3) = heatmapMatrix.iceAvgRxnFromPic.treat1(:,3)/51;
heatmapMatrix.iceICRFromPic.treat1(:,3) = heatmapMatrix.iceICRFromPic.treat1(:,3)/51;
heatmapMatrix.iceTVFromPic.treat1(:,3) = heatmapMatrix.iceTVFromPic.treat1(:,3)/51;

heatmapMatrix.iceFromPic.treat2(:,3) = heatmapMatrix.iceFromPic.treat2(:,3)/51; % might not make sense because ICE needs to be re-computed w/ picture rankings
heatmapMatrix.iceAvgRxnFromPic.treat2(:,3) = heatmapMatrix.iceAvgRxnFromPic.treat2(:,3)/51;
heatmapMatrix.iceICRFromPic.treat2(:,3) = heatmapMatrix.iceICRFromPic.treat2(:,3)/51;
heatmapMatrix.iceTVFromPic.treat2(:,3) = heatmapMatrix.iceTVFromPic.treat2(:,3)/51;

heatmapMatrix.iceFromPic.treat3(:,3) = heatmapMatrix.iceFromPic.treat3(:,3)/51; % might not make sense because ICE needs to be re-computed w/ picture rankings
heatmapMatrix.iceAvgRxnFromPic.treat3(:,3) = heatmapMatrix.iceAvgRxnFromPic.treat3(:,3)/51;
heatmapMatrix.iceICRFromPic.treat3(:,3) = heatmapMatrix.iceICRFromPic.treat3(:,3)/51;
heatmapMatrix.iceTVFromPic.treat3(:,3) = heatmapMatrix.iceTVFromPic.treat3(:,3)/51;
